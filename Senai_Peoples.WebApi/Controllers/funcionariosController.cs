...
using Senai_Peoples.WebApi.Repositories;

namespace Senai_Peoples.WebApi.Controllers
{
    public class funcionariosController
    {
        ...
        public class funcionariosController : ControllerBase
        {
            ...
            /// <summary>
            /// Atualiza um funcionário existente no banco de dados passando o seu id pelo corpo da requisição
            /// </summary>
            /// <param name="id">id do usuário que será atualizado</param>
            /// <param name="generoAtualizado">Objeto funcionário atualizado com as novas informações</param>
